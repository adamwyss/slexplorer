...
namespace Ijv.Redstone.Controls
{
    ...
    /// </summary>
    public class DetailRowHeightConverter : IValueConverter
    {
        /// <summary>
        ...
        {
            return object.Equals(value, double.Parse((string)parameter));
        }

        /// <summary>
        /// Converts a boolean value into a double value.
        /// </summary>
